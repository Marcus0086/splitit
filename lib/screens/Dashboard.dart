...
import 'package:covidui/eventInfo.dart';
import 'package:covidui/screens/createScreencalender.dart';
import 'package:covidui/screens/editscreenCalendar.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Container(
          ...
          color: Colors.white,
          child: StreamBuilder(
            stream: storage.retrieveEvents(widget.user),
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) =>
                                    EditScreen(event: event, user: widget.user),
                              ),
                            );
                          },
                          child: Column(
